  ...
  return (
    <nav className={navClass} id="main-nav">
      ...
      <div className="nav-links">
        ...
        <LeadLink leadType="telegram" href="https://t.me/alasi_awning_system" target="_blank" rel="noopener noreferrer" className="btn-outline" style={{ marginRight: 0, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
