        ...
        <div className="footer-layout" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 60, marginBottom: 56 }}>
          <div>
            ...
            <div style={{ marginTop: 22, display: 'flex', gap: 12 }}>
              ...
              <a href={copy.facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Alasi Facebook" style={{ width: 34, height: 34, border: '1px solid rgba(216,196,168,0.2)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
                <svg width="9" height="15" viewBox="0 0 320 512" fill="var(--c-sand)" aria-hidden="true"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06H297V6.26S260.43 0 225.36 0C152.14 0 104.11 44.38 104.11 124.72v70.62H22.89V288h81.22v224h100.34V288z"/></svg>
              </a>
            </div>
          </div>
          <div>
