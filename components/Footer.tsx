        ...
        <div className="footer-layout" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 60, marginBottom: 56 }}>
          <div>
            ...
            <div style={{ marginTop: 22, display: 'flex', gap: 12 }}>
              <a href="#" style={{ width: 34, height: 34, border: '1px solid rgba(216,196,168,0.2)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
