  ...
  return (
    <section id="contact" className="site-section contact-section" style={{ background: 'var(--c-very-dark)', padding: '140px 64px', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
      ...
      <div className="reveal" style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto' }}>
        <p style={{ fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--tweak-accent)', marginBottom: 24 }}>Ready to Start?</p>
        <h2 style={{ fontFamily: 'var(--tweak-font-heading)', fontSize: 'clamp(40px, 5vw, 68px)', fontWeight: 300, color: 'var(--c-cream)', lineHeight: 1.1, marginBottom: 24 }}>
          Create shade that feels like<br /><em style={{ fontStyle: 'italic' }}>part of the architecture.</em>
        </h2>
        <p style={{ fontSize: 15, color: 'var(--c-sand)', maxWidth: 460, margin: '0 auto 52px', lineHeight: 1.75, opacity: 0.82 }}>
          Book a free consultation. We&apos;ll visit your space, take measurements, and present options — at no cost.
        </p>
        <div className="contact-actions" style={{ display: 'flex', gap: 14, justifyContent: 'center' }}>
          <a href="mailto:info@alasi.ge" className="btn-outline" style={{ background: 'var(--tweak-accent)', borderColor: 'var(--tweak-accent)', padding: '18px 48px' }}>Get a Free Quote</a>
          <a href="https://wa.me/995591000000" className="btn-outline" style={{ borderColor: 'rgba(216,196,168,0.4)', display: 'flex', alignItems: 'center', gap: 10, padding: '18px 48px' }}>
