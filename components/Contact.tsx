    ...
    <section id="contact" className="site-section contact-section" style={{ background: 'var(--c-very-dark)', padding: '140px 64px', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
      ...
      <div className="reveal" style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto' }}>
        ...
        <div className="contact-actions" style={{ display: 'flex', gap: 14, justifyContent: 'center' }}>
          <a href={`mailto:${copy.email}`} className="btn-outline" style={{ background: 'var(--tweak-accent)', borderColor: 'var(--tweak-accent)', padding: '18px 48px' }}>{copy.emailCta}</a>
          <a href={copy.whatsappUrl} className="btn-outline" style={{ borderColor: 'rgba(216,196,168,0.4)', display: 'flex', alignItems: 'center', gap: 10, padding: '18px 48px' }}>
